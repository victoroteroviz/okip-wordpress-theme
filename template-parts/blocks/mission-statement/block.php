...
$scroll_duration_vh = isset($animation['scroll_duration_vh']) ? (int) $animation['scroll_duration_vh'] : 260;
$text_reveal_start = isset($animation['text_reveal_start']) ? (float) $animation['text_reveal_start'] : .08;
$text_reveal_end = isset($animation['text_reveal_end']) ? (float) $animation['text_reveal_end'] : .76;
$char_window = isset($animation['char_window']) ? (float) $animation['char_window'] : .34;
$kicker_reveal_start = isset($animation['kicker_reveal_start']) ? (float) $animation['kicker_reveal_start'] : .72;
